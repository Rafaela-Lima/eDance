...
@section('conteudo')
    <h1 class="mt-5"> Atualizar cadastro de funcionário</h1>
    <form method="POST" action="{{ route('AlterarFuncionario', ['id' => $funcionario->id]) }}">
        {{csrf_field()}}
        <div class="field"><br />
        ...
        <div class="field">
            ...
            <input type="text" name="noCarteiraTrab" value="{{$funcionario->noCarteiraTrab}}" class="form-control @error('noCarteiraTrab') is-invalid @enderror" placeholder="Ex.: 0000000 000-0">
