    ...
    <div class="container" >
        ...
        <div class="row">
            ...
            <div class="col-md-6" style="margin-top: 40px">
                ...
                <h4>Pesquisar estúdio</h4><hr>

                <form action=" {{ route('GerenciarEstudio') }}" method="GET">
                    ...
                    <tbody>
                        ...
                        @if(count($estudios) > 0)
                            @foreach($estudios as $estudio)
                                ...
                                <tr>
                                    <td>{{ $estudio->nome }}</td>
                                    <form method="GET" action="{{ route('EditarEstudio', ['id' => $estudio->id]) }}">
                                        <td><button type="submit" class="btn btn-primary">Atualizar</button> </td>
                                    </form>
                                    <form method="GET" action="{{ route('DeletarEstudio',  ['id' => $estudio->id]) }}">
